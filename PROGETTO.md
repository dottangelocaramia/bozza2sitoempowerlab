...
*Ultimo aggiornamento: 29 agosto 2026 (profilo Angelo rinnovato, pagina Training Autogeno, home con animazioni e sezione articoli, contatti.html restyling)*
...
- Il footer (template/footer.html) mostra la tagline abbreviata "Psicologia e Formazione" (senza "Crescita personale"): NON è stata modificata perché non corrisponde esattamente alla frase indicata da Angelo da sostituire ("Crescita personale, formazione, psicologia"). Da chiedere ad Angelo se vuole uniformarla anch'essa a "Psicologia, Crescita personale e Formazione".
...
- Alcuni file (chi-siamo.html, contatti.html, index.html) hanno piccoli sbilanciamenti preesistenti tra tag di apertura/chiusura (`<div>`/`<a>`) risalenti a prima di questa sessione di lavoro; non introdotti oggi, segnalati per completezza ma non urgenti (il sito li ha sempre avuti senza problemi visibili).
